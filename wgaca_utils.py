...
ADDRESSES = hierarchy = {'United Kingdom': {'Exeter, Devon': {'Topsham': ['Hamilton Road',
                                                  'Strand',
                                                  'Wendover Way',
                                                  'Western Avenue',
                                                  'Ashford Road',
                                                  ...
                                                  'The Retreat Drive',
                                                  'Third Avenue']},
                    'Hammersmith & Fulham, London': {'Fulham': ['Munster Road',
                                                                'Fulham Palace '
                                                                'Road',
                                                                "New King's "
                                                                'Road'],
                                                     'Hammersmith': ['Talgarth '
                                                                     ...
                                                                     'Hammersmith '
                                                                     'Road']},
                    'Kingston-upon-Thames, London': {'': ['Richmond Road',
                                                          'London Road',
                                                          'Kingston Hill'],
                                                     'New Malden': ['Salisbury '
                                                                    'Road',
                                                                    'Coombe '
                                                                    'Road']},
                    'Lambeth, London': {'Brixton': ['Acre Lane',
                                                    'Town Hall Parade'],
                                        'Clapham Town': ['The Pavement',
                                                         'Venn Street',
                                                         'Clapham High '
                                                         'Street']},
                    'Merton, London': {'Mitcham': ['Croydon Road',
                                                   'Madeira Road'],
                                       'Morden': ['St Helier Avenue',
                                                  'Central Road',
                                                  'London Road']},
                    'Wandsworth, London': {'Balham': ['Royal Duchess Mews',
                                                      'Harberson Road',
                                                      'Beira Street',
                                                      'Gaskarth Road',
                                                      'Amner Road',
