...
class MyOffers(MyOffersTemplate):
    ...
    def __init__(self, **properties):
        ...
        self.radio_button_2.value = f"Items in {self.user['street'] or 'my Street'}"
        self.radio_button_3.value = f"Items in {self.user['town'] or 'my Town'}"
        self.radio_button_4.value = f"Items in {self.user['county'] or 'my County'}"
